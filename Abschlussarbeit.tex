...
// Abbildung \ref{fig:html5specs}\\
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{tmp/HTML5-Spezifikationen.png}
...
// Abbildung \ref{fig:dombeispielbaum}\\
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=0.5\linewidth]{tmp/DOM_Beispielbaum.png}
...
// Abbildung \ref{fig:cssboxmodell}\\
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{tmp/CSS-Boxmodell.png}
