...
Selbstverständlich bietet das DOM die Möglichkeit der Modifizierung. So lassen sich Knoten nicht nur ändern, sondern auch entfernen und neu hinzufügen. Außerdem ist auf Grund der Baumstruktur ein Löschen eines Knotens möglich ohne die Integrität des Baumes zu zerstören.\\//Eventuell DOM Manipulation ausführlicher
...
\begin{figure}[htb]
  ...
  \label{fig:ajax}
\end{figure}
\footnotetext{Bildquelle: \cite{ajax}}
...
\end{figure}
\footnotetext{Bildquelle: \cite{SAPUXPDF}}
