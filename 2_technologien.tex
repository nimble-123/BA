...
\end{figure}
\footnotetext{Bildquelle: \cite{PeteKroe2014}}	
...
%		\hline
%	\end{tabular}
%	\captionof{HTML 5 Browserkompatibilität}
...
%		\hline
%	\end{tabular}
%	\captionof{JavaScript Schlüsselwörter}
...
\begin{figure}[htb]
  ...
  \caption[DOM Beispielbaum]{DOM Beispielbaum}
...
\begin{figure}[htb]
  ...
  \label{fig:ajax}
\end{figure}
\footnotetext{Bildquelle: \cite{JesseJGarret}}
...
Kapitel 2.4 beschreibt das SAP UI 5 Framework der SAP AG aus technischer Sicht. Zu aller erst wird die aktuelle UI Strategie der SAP AG beschrieben um zu verstehen wieso die SAP AG dieses Framework entwickelt hat. Im Anschluss kommt eine allgemeine Definition und Beschreibung des verwendeten Softwarearchitektur. Zuletzt folgt eine kurze Erklärung des OData Protokolls und der Positionierung des Frameworks innerhalb eines Netweaver Stacks.
...
\begin{figure}[htb]
  ...
  \label{fig:mvcarch}
\end{figure}
\footnotetext{Bildquelle: \cite[S.123]{AntoEinf2014}}	
...
\begin{figure}[htb]
  ...
  \label{fig:mvcarch2}
\end{figure}
\footnotetext{Bildquelle: \cite[S.124]{AntoEinf2014}}
